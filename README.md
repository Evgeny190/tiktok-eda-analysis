...
2. Place `tiktok_dataset.csv` inside the `data/` folder.
...
4. Open `tiktok_eda_analysis.ipynb` in Jupyter Notebook or JupyterLab.
5. Run all cells.
...
This project uses an educational dataset and project scenario from the Google Advanced Data Analytics coursework on Coursera. The portfolio structure, written interpretation, and engagement-rate extension were added to present the work as a standalone case study.
